...
func NewKuaicheCreativeListV2Request() (req *KuaicheCreativeListV2Request) {
	request := sdk.Request{MethodName: "jingdong.ads.dsp.rtb.kc.ad.list.v2", Params: make(map[string]interface{}, 2)}
	req = &KuaicheCreativeListV2Request{
		Request: &request,
	}
	return
}

func (req *KuaicheCreativeListV2Request) SetData(data *KuaicheCreativeListV2RequestData) {
	req.Request.Params["data"] = data
}

func (req *KuaicheCreativeListV2Request) GetData() *KuaicheCreativeListV2RequestData {
	data, found := req.Request.Params["data"]
	if found {
		return data.(*KuaicheCreativeListV2RequestData)
	}
	return nil
}

func (req *KuaicheCreativeListV2Request) SetSystem(system *dsp.JdDspPlatformGatewayApiVoParamExt) {
	req.Request.Params["system"] = system
}

func (req *KuaicheCreativeListV2Request) GetSystem() *dsp.JdDspPlatformGatewayApiVoParamExt {
