...
type ShopGiftGroupModelListData struct {
	...
	Result    *ShopGiftGroupModelListResult `json:"commonResult,omitempty" codec:"createisvshopgift_result,omitempty"`
}
...
func ShopGiftGroupModelList(req *ShopGiftGroupModelListRequest) ([]*ShopGiftGroupModel, error) {
	...
	if response.Data.Result == nil {
		return nil, errors.New("No create promotion result.")
	}
